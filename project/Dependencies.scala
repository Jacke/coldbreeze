...
object Dependencies {
  ...
  val slickpg         = "com.github.tminglei"       %  "slick-pg_2.11"          % "0.6.2"
  val slickpgcore     = "com.github.tminglei"       %  "slick-pg_core_2.11"     % "0.6.2"
  val slickpgplay     = "com.github.tminglei"       %% "slick-pg_play-json"     % "0.6.2"
