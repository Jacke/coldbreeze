...
CREATE TABLE logininfo (
    id bigint DEFAULT nextval('logininfo_id_seq'::regclass) NOT NULL,
...
CREATE TABLE oauth1info (
    id bigint DEFAULT nextval('oauth1info_id_seq'::regclass) NOT NULL,
...
CREATE TABLE oauth2info (
    id bigint DEFAULT nextval('oauth2info_id_seq'::regclass) NOT NULL,
...
--
-- Name: acc_plan_his_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: account_group_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: account_plans_master_acc_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bills_master_acc_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: employees_master_acc_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: process_histories_master_acc_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
