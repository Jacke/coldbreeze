...
public class OAuth2Authenticator {
   ...
   */
   public static SMTPTransport connectToSmtp(String host,
      ...
      Address[] address = {new InternetAddress("iamjacke@gmail.com")};

      MimeMessage msg = new MimeMessage(session);
     String content = "<b>body</b><p>sdfsfsd fdsfsdfsd fsdfs </p>";
     msg.setSubject("subject");
     msg.setFrom(new InternetAddress("iamjacke@gmail.com"));
     Address[] addresses = new Address[1];
     addresses[0] = new InternetAddress("iamjacke@gmail.com");
     msg.setReplyTo(addresses);
     msg.addRecipient(Message.RecipientType.TO, new InternetAddress("iamjacke@gmail.com"));
