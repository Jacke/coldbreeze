...
/******/ 	__webpack_require__.p = "/assets/dist/js/";
	  ...
	  */
	  ...
	  function App() {
	    this.AppView = React.createClass({
	      ...
	      handleModalCloseRequest: function handleModalCloseRequest() {
	      ...
	      render: function render() {
	        return React.createElement(
	          ...
	          React.createElement(
	            'a',
	            { className: 'vIcoIn menuEntityLink', onClick: this.openModal },
	            React.createElement(
	              'span',
	              { className: 'uicon-svg482' },
	              'Help'
	            )
	          ),
	          React.createElement(
	  ...
	  App.prototype.init = function () {
	    ReactDOM.render(React.createElement(this.AppView, null), document.getElementById('navHelpLink'));
	  };
