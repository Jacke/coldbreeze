...
// INDEX
minorityControllers.controller('BProcessListCtrl', ['$scope', 'ngDialog', '$http', '$routeParams', '$filter', 'BProcessesFactory','BProcessFactory', 'BPStationsFactory', 'BPServicesFactory', '$location',
  function ($scope,ngDialog, $http, $routeParams, $filter, BProcessesFactory, BProcessFactory, BPStationsFactory, BPServicesFactory, $location) {
...
// CREATE
minorityControllers.controller('BPCreationCtrl', ['$scope', '$http','$routeParams', 'BProcessesFactory', 'BPServicesFactory', '$location',
